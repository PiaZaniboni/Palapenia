...
<div class="row">
<div class=" jumbotron hero-spacer ">
<div class="col-sm-3 "><img class="img-responsive wow fadeIn" src="images/3.jpg" alt="" ></div>
<div class="col-sm-3 "><img class="img-responsive wow fadeIn" src="images/3.jpg" alt="" ></div>
...
materiales de gran calidad,</br> con un corte elegante y cómodo. </br>
Por eso cada una de las prendas estan intervenidas</br> de manera
especial que las hace<strong> únicas.</strong> </br> Durante la temporada se renuevan las prendas y los géneros,</br> dando en muchas ocasiones exclusividad a nuestras clientas.</p>
        ...
        <h2>CONTACTANOS</h2>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-default submit"> Enviar</button>
                        </div>
        ...
        <div class="contacto">           
      <ul class="fa-ul  ">
  <li><i class="fa-li fa fa-facebook-square   fa-lg"></i>Palapenia</li>
  <li><i class="fa-li fa fa-instagram   fa-lg"></i>Palapenia</li>
  <li><i class="fa-li fa fa-envelope-o   fa-lg"></i>Mayoristas: ventas@palapenia.com </br>Minoristas: info@palapenia.com</li>
  <li><i class="fa-li fa fa fa-phone-square   fa-lg"></i>11.5489.9329</li>
  <li><i class="fa-li fa fa-map-marker   fa-lg"></i>City Bell, La Plata</li>
                    ...
                    <div class="col-md-6 ">
                    <img class="img-responsive wow wow fadeIn" src="images/3.jpg" alt="" >
                    </div>
</div>
